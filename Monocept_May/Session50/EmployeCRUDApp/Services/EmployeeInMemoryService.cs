...
{
    public class EmployeeInMemoryService :IEmployeeServices
    {
        public static EmployeeInMemoryService employeeService;
        ...
        public static EmployeeInMemoryService GetInstance()
        {
            ...
            {
                employeeService=new EmployeeInMemoryService();
            }
